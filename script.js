...
const clickSound = new Audio(
	"assets/audios/assets_audio_lclick-13694.mp3"
);
const wrongSound = new Audio(
	"assets/audios/assets_audio_mixkit-wrong-long-buzzer-954.wav"
);
const correctSound = new Audio(
	"assets/audios/assets_audio_mixkit-winning-chimes-2015.wav"
);
